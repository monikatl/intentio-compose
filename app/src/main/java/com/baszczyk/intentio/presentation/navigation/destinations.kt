package com.baszczyk.intentio.presentation.navigation
...
enum class Destination(
    ...
    CALENDAR("calendar", "Kalendarz", Icons.Default.DateRange, "Kalendarz")
}
...
enum class ActivationDestination(
    ...
    ACTIVATION("activation", "Rejestracja Parafii", "activation"),
    LOGIN("login", "Logowanie", "login"),
